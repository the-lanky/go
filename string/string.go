...
// LankyStringManipulation is an interface that holds all abstract methods to manipulate strings
type LankyStringManipulation interface {
	Acronym() LankyStringManipulation
	Between(start, end string) LankyStringManipulation
	Boolean() bool
	PascalCase(rule ...string) LankyStringManipulation
	CamelCase(rule ...string) LankyStringManipulation
	ContainsAll(check ...string) bool
	Delimited(delimiter string, rule ...string) LankyStringManipulation
	First(length int) string
	Get() string
	KebabCase(rule ...string) LankyStringManipulation
	...
	SnakeCase(rule ...string) LankyStringManipulation
...
func New(val string) LankyStringManipulation {
...
func (i *input) Acronym() LankyStringManipulation {
	input := getInput(*i)
...
func (i *input) Between(start, end string) LankyStringManipulation {
...
// Result : helloUser
func (i *input) CamelCase(rule ...string) LankyStringManipulation {
	input := getInput(*i)
...
// Example input: hello user
// Result : HelloUser
func (i *input) PascalCase(rule ...string) LankyStringManipulation {
	input := getInput(*i)
	// removing excess space
	wordArray := caseHelper(input, true, rule...)
	for i, word := range wordArray {
...
func (i *input) Delimited(delimiter string, rule ...string) LankyStringManipulation {
	input := getInput(*i)
...
// Example input: hello user
// Result : hello-user
func (i *input) KebabCase(rule ...string) LankyStringManipulation {
	input := getInput(*i)
	wordArray := caseHelper(input, false, rule...)
	i.Result = strings.Join(wordArray, "-")
	return i
...
func (i *input) SnakeCase(rule ...string) LankyStringManipulation {
	input := getInput(*i)
	wordArray := caseHelper(input, false, rule...)
